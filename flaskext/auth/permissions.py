...
class Permission(object):
    ...
    :attr resource: A resource is a component on which actions can be performed.
    Examples: post, user, ticket, product, but also post.comment, user.role,
    etc.
    :attr action: Any action that can be performed on a resource. Names of actions
...
class Role(object):
    ...
    :attr permissions: A list of permissions.
    """
